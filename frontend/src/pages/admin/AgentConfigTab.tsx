    ...
    return (
      <div className="max-w-xl space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium">{editing === 'new' ? t('agents.newAgent') : t('agents.editAgent', { name: editing.name })}</h3>
        </div>
        <AgentForm
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-sm font-medium">{t('admin.agentTemplates.title')}</h3>
          <p className="text-xs text-muted-foreground mt-0.5">{t('admin.agentTemplates.description')}</p>
        </div>
