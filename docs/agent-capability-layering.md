...
├── movscript-workspace.pack.json   // 当前 UI 上下文和 MovScript 项目读取
├── proposal-router.pack.json       // 泛提案请求路由
├── proposal-project.pack.json      // 提案 project:设定资料 + 绑定设定资料的素材需求
├── proposal-production.pack.json   // 提案 production:情绪段 + 绑定情绪段的情景段
├── proposal-asset.pack.json        // 独立素材提案层
├── proposal-content-unit.pack.json // 内容单元/分镜/关键帧规划提案
└── visual-generation.pack.json     // 视觉生成执行工具 + workflow
```
...
export interface CapabilityPack {
  id: string                       // 'movscript.pack.proposal-project'
...
```json
{
  ...
  "enabledPacks": [
    ...
    "movscript.pack.movscript-workspace",
    "movscript.pack.proposal-router",
    "movscript.pack.proposal-project",
    "movscript.pack.proposal-production",
    "movscript.pack.proposal-asset",
    "movscript.pack.proposal-content-unit",
    "movscript.pack.visual-generation"
  ],
...
└── apps/agent/
    ...
    │   │   ├── core.pack.json
    │   │   ├── drafts.pack.json
    │   │   ├── movscript-workspace.pack.json
    │   │   ├── proposal-router.pack.json
    │   │   ├── proposal-project.pack.json
    │   │   ├── proposal-production.pack.json
    │   │   ├── proposal-asset.pack.json
    │   │   ├── proposal-content-unit.pack.json
...
| Pack | `<vendor>.pack.<name>` | `movscript.pack.proposal-project` |
