...
var pipelineTemplates = map[string]templateDef{
	"full_production": {
		Nodes: []templateNodeDef{
			...
			{Type: "episode_edit", ContentType: "custom", Name: "剧集剪辑", PosX: 2300, PosY: 200},
			{Type: "episode", ContentType: "custom", Name: "成片剧集", PosX: 2520, PosY: 200},
		},
	...
	"from_script": {
		Nodes: []templateNodeDef{
			...
			{Type: "episode_edit", ContentType: "custom", Name: "剧集剪辑", PosX: 2080, PosY: 200},
			{Type: "episode", ContentType: "custom", Name: "成片剧集", PosX: 2300, PosY: 200},
		},
	...
	"from_storyboard": {
		Nodes: []templateNodeDef{
			...
			{Type: "episode_edit", ContentType: "custom", Name: "剧集剪辑", PosX: 760, PosY: 200},
			{Type: "episode", ContentType: "custom", Name: "成片剧集", PosX: 980, PosY: 200},
		},
