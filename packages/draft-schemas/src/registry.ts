...
export const assetProposalSchema = {
  ...
  promptSummary: [
    ...
    '- Treat proposal.asset_slots as a full snapshot, not a partial patch. When preserving or updating an existing draft, keep every existing asset slot id unchanged; copy unchanged slots back with the same id, and mark removed slots with status: "waived" instead of omitting them.',
