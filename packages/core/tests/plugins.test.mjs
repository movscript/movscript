...
test('core plugins read provider plugin archive manifests and catalog files', async () => {
...
test('core plugins normalize provider marketplace inventories', () => {
...
test('core plugins normalize local plugin lists as installed provider plugins', () => {
...
test('core plugin marketplace rules stay independent from frontend runtime', () => {
  const source = readFileSync(new URL('../src/plugins/providerPluginMarketplace.ts', import.meta.url), 'utf8')
