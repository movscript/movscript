...
const agentProtocolRoot = resolve(repoRoot, 'packages/agent-protocol')
...
test('core agent protocol keeps provider, conversation, timeline, generation, and interaction contracts in focused modules', () => {
  ...
  const agentProtocolSource = readFileSync(agentProtocolPath('src/index.ts'), 'utf8')
  const attachmentSource = readFileSync(agentProtocolPath('src/agentAttachmentProtocol.ts'), 'utf8')
  const attachmentInputsSource = readFileSync(packagePath('src/agent/attachmentInputs.ts'), 'utf8')
  const conversationSource = readFileSync(agentProtocolPath('src/agentConversationProtocol.ts'), 'utf8')
  const generationSource = readFileSync(agentProtocolPath('src/agentGenerationProtocol.ts'), 'utf8')
  const planSource = readFileSync(agentProtocolPath('src/agentPlanProtocol.ts'), 'utf8')
  const protocolVersionSource = readFileSync(agentProtocolPath('src/agentProtocolVersion.ts'), 'utf8')
  const promptDebugSource = readFileSync(agentProtocolPath('src/agentPromptDebugProtocol.ts'), 'utf8')
  const runSource = readFileSync(agentProtocolPath('src/agentRunProtocol.ts'), 'utf8')
  const statusSource = readFileSync(agentProtocolPath('src/agentStatusProtocol.ts'), 'utf8')
  const taskGraphSource = readFileSync(agentProtocolPath('src/agentTaskGraphProtocol.ts'), 'utf8')
  const threadSource = readFileSync(agentProtocolPath('src/agentThreadProtocol.ts'), 'utf8')
  const timelineSource = readFileSync(agentProtocolPath('src/agentTimelineProtocol.ts'), 'utf8')
  const toolSource = readFileSync(agentProtocolPath('src/agentToolProtocol.ts'), 'utf8')
  const traceSource = readFileSync(agentProtocolPath('src/agentTraceProtocol.ts'), 'utf8')
  const providerCatalogSource = readFileSync(agentProtocolPath('src/providerCatalog.ts'), 'utf8')
  const providerInteractionSource = readFileSync(agentProtocolPath('src/providerInteractionProtocol.ts'), 'utf8')
  const providerModelSource = readFileSync(agentProtocolPath('src/providerModelProtocol.ts'), 'utf8')
  const providerSessionSource = readFileSync(agentProtocolPath('src/providerSessionProtocol.ts'), 'utf8')
  const modelCatalogSource = readFileSync(packagePath('src/agent/modelCatalog.ts'), 'utf8')

  assert.match(protocolSource, /export \* from '@movscript\/agent-protocol'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentAttachmentProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentConversationProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentGenerationProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentPlanProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentProtocolVersion\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentPromptDebugProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentRunProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentStatusProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentTaskGraphProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentThreadProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentTimelineProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentToolProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/agentTraceProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/providerCatalog\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/providerInteractionProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/providerModelProtocol\.js'/)
  assert.match(agentProtocolSource, /export \* from '\.\/providerSessionProtocol\.js'/)
...
function agentProtocolPath(path) {
  return resolve(agentProtocolRoot, path)
}
