...
export const productionOrchestrationEntityKinds = [
  'productions',
  'segments',
  'sceneMoments',
  'settings',
...
export function isActiveProductionOrchestrationRecord(record: Record<string, unknown>): boolean {
...
export function productionOrchestrationOwnerKey(ownerType: string, ownerId: number): string {
  return `${ownerType}:${ownerId}`
}

function pushGroupedRecord<T>(map: Map<string | number, T[]>, key: string | number, value: T): void {
