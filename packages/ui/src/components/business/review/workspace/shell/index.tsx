...
export function ReviewWorkspaceShell({
  ...
  return (
    <AppSection
      ...
      className={cn("review-workspace-shell", layout !== "default" && `review-workspace-shell--${layout}`, className)}
      bodyClassName={layout !== "default" ? "review-workspace-shell__body" : undefined}
    >
      {children}
    </AppSection>
  );
