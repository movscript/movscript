...
export function AppSettingsMain({
  className,
  ...props
}: HTMLAttributes<HTMLElement>) {
...
export function AppSettingsContentStack({
  className,
  ...props
}: HTMLAttributes<HTMLElement>) {
...
export function AppSettingsChoiceGrid({
  className,
  ...props
}: HTMLAttributes<HTMLDivElement>) {
...
export function AppSettingsEndpointSurface({
  label,
  value,
}: {
  label: ReactNode;
...
export function AppSettingsActionRow({
  className,
  ...props
}: HTMLAttributes<HTMLDivElement>) {
...
export function AppSettingsFooterText({
  className,
  ...props
}: HTMLAttributes<HTMLParagraphElement>) {
