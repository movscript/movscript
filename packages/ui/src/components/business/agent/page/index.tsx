...
/**
 * @deprecated Agent page orchestration belongs in app features. Keep this legacy
 * package entry only while current consumers migrate to feature-owned wrappers.
 */
