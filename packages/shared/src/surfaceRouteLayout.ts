...
export const sharedSurfaceRouteDefinitions: readonly SharedSurfaceRouteDefinition[] = [
  ...
  route({
    ...
    area: 'project',
    primaryNavKey: 'project',
    desktopPathPatterns: ['/project/home', '/studio/:projectKey/overview'],
    localPathPatterns: ['/studio/:projectKey/overview'],
    scrollMode: 'document',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'project',
    primaryNavKey: 'project',
    desktopPathPatterns: ['/project/settings', '/studio/:projectKey/settings'],
    localPathPatterns: ['/studio/:projectKey/settings'],
    scrollMode: 'document',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'project',
    primaryNavKey: 'project',
    desktopPathPatterns: ['/project/scripts/workbench', '/studio/:projectKey/scripts'],
    localPathPatterns: ['/studio/:projectKey/scripts'],
  ...
  route({
    ...
    area: 'project',
    primaryNavKey: 'project',
    desktopPathPatterns: ['/project/standards', '/studio/:projectKey/standards'],
    localPathPatterns: ['/studio/:projectKey/standards'],
    scrollMode: 'workspace',
    shellLayout: 'stacked',
  }),
  route({
    ...
    desktopPathPatterns: ['/project/content', '/studio/:projectKey/content'],
    localPathPatterns: ['/studio/:projectKey/content'],
    scrollMode: 'canvas',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'workflow',
    primaryNavKey: 'workflow',
    desktopPathPatterns: ['/project/content/canvas', '/studio/:projectKey/content/canvas'],
    localPathPatterns: ['/studio/:projectKey/content/canvas'],
    scrollMode: 'canvas',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'workflow',
    primaryNavKey: 'workflow',
    desktopPathPatterns: ['/project/content/preview', '/studio/:projectKey/content/preview'],
    localPathPatterns: ['/studio/:projectKey/content/preview'],
    scrollMode: 'canvas',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'workflow',
    primaryNavKey: 'workflow',
    desktopPathPatterns: ['/project/settings/preview', '/studio/:projectKey/settings/preview'],
    localPathPatterns: ['/studio/:projectKey/settings/preview'],
    scrollMode: 'canvas',
    shellLayout: 'stacked',
  }),
  route({
  ...
  route({
    ...
    area: 'tool',
    primaryNavKey: 'tool',
    desktopPathPatterns: ['/tools/image'],
    localPathPatterns: ['/tools/image'],
    scrollMode: 'workspace',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'tool',
    primaryNavKey: 'tool',
    desktopPathPatterns: ['/tools/video'],
    localPathPatterns: ['/tools/video'],
    scrollMode: 'workspace',
    shellLayout: 'stacked',
  }),
  route({
    ...
    area: 'tool',
    primaryNavKey: 'tool',
    desktopPathPatterns: ['/tools/audio'],
    localPathPatterns: ['/tools/audio'],
    scrollMode: 'workspace',
    shellLayout: 'stacked',
  }),
  route({
