...
import { invalidateShotLibraryMutationResult, shotReferencesChangedResult } from '../application/shotLibraryMutationInvalidation'
import { toast } from '@movscript/ui/toast'
import type { PaginatedResponse, RawResource } from '@movscript/shared'
import {
...
import { ShotImportDialog } from './ShotLibraryImportDialog'
import { ShotReferenceDetail } from './ShotLibraryReferenceDetail'
import {
  ShotLibraryBrowser,
  ShotLibraryHeader,
  ShotLibraryMetrics,
  ShotLibraryToolbar,
} from './ShotLibraryPageSections'
import { SHOT_LIBRARY_PAGE_SIZE } from './shotLibraryPagination'
import { useShotLibraryImportController } from './useShotLibraryImportController'
...
const FALLBACK_APP_SETTINGS = {
  ...
  shotLibrarySources: undefined,
  defaultShotLibrarySourceId: undefined,
} as const
export default function ShotLibraryPage() {
  const { t, i18n } = useTranslation()
  const settings = {
    ...FALLBACK_APP_SETTINGS,
    ...useSurfaceHostState((state) => state.appSettings),
  }
