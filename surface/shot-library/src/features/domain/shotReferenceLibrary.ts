...
import type { SurfaceHttpClient, SurfaceHttpRequestConfig } from '@movscript/shared/surface-http'
import {
...
} from '@movscript/shot-library'
import type { ShotLibrarySourceConfig } from '@movscript/shared'
import {
...
export async function uploadShotReferenceToSource(
  ...
  source: ShotLibrarySource,
  form: FormData,
  config: SurfaceHttpRequestConfig = {},
...
function requestConfigForSource(source: ShotLibrarySource): SurfaceHttpRequestConfig {
  return {
