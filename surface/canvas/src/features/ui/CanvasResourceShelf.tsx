...
import { resourceMatchesSearch, resourceToNodeType } from '../integrations/resources'
import {
  canvasResourceKeys,
...
import { resourceMediaDiagnosticsEnabled } from '@movscript/resource-surface/resource-media-diagnostics'
import {
