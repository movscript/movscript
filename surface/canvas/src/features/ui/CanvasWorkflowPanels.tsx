...
import { resolveResourceUrl } from '@movscript/resource-surface/resource-media'
...
import type { Canvas, CanvasRunStatus } from '@movscript/shared'
import type { CanvasRuntimeRun } from '../runtime/runHistoryStore'
import { canvasPortValuePreviewText, workflowRunOutputItems } from '../runtime/runtimeValues'
import { CanvasResourceShelf } from './CanvasResourceShelf'
import { WorkflowReferencePicker } from './CanvasWorkflowReferencePicker'
        ...
        <CanvasWorkflowSidePanel width={width}>
          ...
          <CanvasWorkflowSideBody>
            {activeTab === 'resources' ? (
              ...
              <WorkflowReferencePicker currentCanvasId={currentCanvasId} onAddWorkflowReference={onAddWorkflowReference} />
            ) : (
              <WorkflowRunHistory
                embedded
                compact
