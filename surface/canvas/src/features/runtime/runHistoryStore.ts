...
import type { CanvasPortValue, CanvasRunStatus, CanvasTaskStatus, RawResource } from '@movscript/shared'
...
function getCanvasRuntimeStorage(): StateStorage {
  ...
  return createSurfaceStateStorage(CANVAS_RUNTIME_STORAGE_KEY, fallback)
}
