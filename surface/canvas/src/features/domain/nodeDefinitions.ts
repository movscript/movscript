...
export const CANVAS_NODE_DEFINITIONS: CanvasNodeDefinition[] = [
  ...
  },
  {
    ...
    category: 'ai',
    inputs: [port('references', 'image', { mediaType: 'image', role: 'reference_image', required: true, maxCount: 8 }), port('prompt', 'text')],
    outputs: [port('image', 'image')],
    defaultData: { source: 'ai', label: 'Reference Image', outputType: 'image', modelOperation: 'image_to_image' },
  },
  {
    type: 'ref_video_gen',
    ...
    category: 'ai',
    inputs: [
      port('reference_images', 'image', { mediaType: 'image', role: 'reference_image', required: false, maxCount: 0 }),
      port('reference_video', 'video', { mediaType: 'video', role: 'reference_video', required: false, maxCount: 1 }),
      port('reference_audio', 'audio', { mediaType: 'audio', role: 'reference_audio', required: false, maxCount: 1 }),
      port('prompt', 'text'),
    ],
    outputs: [port('video', 'video')],
    defaultData: { source: 'ai', label: 'Reference Video', outputType: 'video', modelOperation: 'reference_to_video' },
  },
  {
    type: 'multi_angle',
    ...
    category: 'ai',
    inputs: [port('character_or_object', 'image', { mediaType: 'image', role: 'reference_image', required: true }), port('prompt', 'text')],
    outputs: [port('multi_angle_image', 'image')],
    defaultData: { source: 'ai', label: 'Multi-angle Image', outputType: 'image', modelOperation: 'reference_to_image' },
  },
  {
    type: 'style_transfer',
    ...
    category: 'ai',
    inputs: [port('target', 'image', { mediaType: 'image', role: 'source_image', required: true }), port('style_reference', 'image', { mediaType: 'image', role: 'style_reference', required: true }), port('prompt', 'text')],
    outputs: [port('styled_image', 'image')],
    defaultData: { source: 'ai', label: 'Style Transfer', outputType: 'image', modelOperation: 'style_transfer' },
  },
  {
    ...
    category: 'ai',
    inputs: [port('character', 'image', { mediaType: 'image', role: 'reference_image', required: true }), port('motion_reference', 'video', { mediaType: 'video', role: 'motion_reference', required: true }), port('prompt', 'text')],
    outputs: [port('video', 'video')],
    defaultData: { source: 'ai', label: 'Motion Imitation', outputType: 'video', modelOperation: 'reference_to_video' },
  },
  {
    type: 'canvas',
