...
import { CANVAS_NODE_CATEGORIES } from '../presentation/nodeCatalog'
import {
  CANVAS_WORKFLOW_PANE_MAX_WIDTH,
  CANVAS_WORKFLOW_PANE_MIN_WIDTH,
} from '../presentation/canvasWorkspaceLayoutSpec'
import { TextNode, ImageNode, VideoNode, ToolNode, InputNode, OutputNode, ResourceSinkNode, ApprovalNode, TextGenNode, AIGenNode, GroupNode } from '../ui/CanvasNodes'
...
export const canvasEditorNodeTypes: NodeTypes = {
  ...
  video: VideoNode,
  canvas: ToolNode,
  reference_to_image: ToolNode,
  reference_to_video: ToolNode,
  input: InputNode,
  output: OutputNode,
