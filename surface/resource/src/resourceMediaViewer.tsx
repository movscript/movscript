...
import { Download, File, FileAudio, FileText, Maximize2, PlayCircle, X } from 'lucide-react'
...
import { AuthedImage, AuthedVideo } from './resourceAuthMedia.js'
import { HlsVideo } from './resourceHlsVideo.js'
import { ResourceAudio, isHlsResource } from './resourceMediaComponents.js'
import { downloadResource, loadResourceTextUrl, resolveResourceUrl } from './resourceMediaBrowser.js'
import { resourceTextKeys } from './resourceQueryKeys.js'
...
export function MediaViewer({
  ...
  const setOpen = isControlled ? (nextOpen: boolean) => onOpenChange?.(nextOpen) : setInternalOpen
