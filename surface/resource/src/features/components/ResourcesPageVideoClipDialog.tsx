...
import { UrlVideo } from '../../resourceMediaComponents.js'
import {
...
import { formatTime, RangeField } from './ResourcesPageVideoClipDialogParts'
import { useVideoClipDialogController } from './useVideoClipDialogController'
          ...
          <ResourceClipLayout>
            ...
            <ResourceClipSidebar>
              <ResourceDialogStack density="loose">
                ...
                {(clipError || clipStatus.unavailableReason === 'host_unavailable') && (
                  <ResourceStateMessage tone="danger">
