export const PROJECT_STANDARDS_WORKSPACE_WORKSPACE_SCHEMA = 'movscript.workspace.project-standards.v1'
export const PROJECT_STANDARDS_WORKSPACE_SCOPE = 'project_standards_workspace'
