...
import type { ProjectStandardsReviewWorkspace } from '../../application/projectStandardsModel.js'
import { projectStandardsWorkspaceStatusRecipe } from '../../presentation/projectStandardsSemanticUi.js'
            ...
            {workspaceView ? (
              <>
                ...
                <ProjectWorkspaceReviewCallout tone="neutral" compact title="历史">
                  这份工作区来自项目 Surface runtime；详细来源记录保留在 workspace metadata 中。
                </ProjectWorkspaceReviewCallout>
              </>
            ) : (
              <ProjectWorkspaceReviewEmptyText>
