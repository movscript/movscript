...
const projectStandardsReadinessStatus = defineStatusRecipeGroup('project-standards.readiness.status', {
  ready: 'success',
  missing: 'warning',
  default: 'neutral',
})

const projectStandardsRuleStatus = defineStatusRecipeGroup('project-standards.rule.status', {
  enabled: 'success',
  required: 'warning',
  default: 'neutral',
})

const projectStandardsWorkspaceStatus = defineStatusRecipeGroup('project-standards.workspace.status', {
  applied: 'success',
  rejected: 'danger',
  workspace: 'warning',
  default: 'neutral',
