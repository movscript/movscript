...
import { surfaceRoutePath, type WorkspaceArtifact } from '@movscript/shared'
import type { ProjectStandardsReviewWorkspace } from '../../application/projectStandardsModel'
import { projectStandardsWorkspaceStatusRecipe } from '../../presentation/projectStandardsSemanticUi'
                ...
                <ProjectWorkspaceReviewCallout tone="neutral" compact title="历史">
                  <div className="flex justify-end">
                    <ProjectWorkspaceReviewActionButton size="xs" variant="outline" className="gap-1.5" asChild>
                      <Link to={surfaceRoutePath('agent.console')}>
                        <FileText size={12} />
