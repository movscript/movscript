import type { ElectronMediaPipelineEditingProject } from './contracts'
...
import { listenToWindowEvent, publishWindowEvent } from './window-events'
...
function dispatchEditingProjectRegistryChanged(): void {
  publishWindowEvent(EDITING_PROJECT_REGISTRY_CHANGED_EVENT)
}
