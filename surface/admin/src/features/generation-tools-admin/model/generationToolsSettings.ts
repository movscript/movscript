export type AdminGenerationToolServer = {
  id: string
  scope: 'admin' | 'local'
  type: 'comfyui' | 'webui'
  name: string
...
export type AdminGenerationToolsSettings = {
...
export type GenerationToolConnectionTestResult = {
  success: boolean
  latency_ms?: number
  status_code?: number
  message?: string
...
export const emptyAdminGenerationToolsSettings: AdminGenerationToolsSettings = {
  servers: [],
  default_server_id: '',
  default_server_ids: {},
  allow_local: true,
...
export function createAdminGenerationToolServer(type: AdminGenerationToolServer['type']): AdminGenerationToolServer {
...
export function adminGenerationToolServerValid(server: AdminGenerationToolServer): boolean {
...
export function adminGenerationToolServerMatchesSaved(current: AdminGenerationToolServer, saved?: AdminGenerationToolServer): boolean {
...
export function normalizeAdminGenerationToolTags(tags: string[] | undefined): string[] {
...
export function clearAdminGenerationToolDefaultServerID(
