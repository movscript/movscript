...
export interface AIProviderCredential {
  ...
  masked_secrets_json: string
  plain_config_json: string
...
export interface AIProvider {
  ...
  trusted_resource_state_json: string
  health_json: string
  is_enabled: boolean
...
export interface AIProviderTemplate {
  ...
  description?: string
  default_adapter_type?: string
  default_adapter_key: string
  default_base_url_prefix: string
  capabilities_json?: Record<string, unknown>
  asset_library_capabilities_json?: Record<string, unknown>
  generated_artifact_trust_policy_json?: Record<string, unknown>
  upstream_provider_kinds_json?: string[]
  is_builtin: boolean
  is_enabled: boolean
  version: string
}

export interface AIProviderTemplatesResponse {
  items: AIProviderTemplate[]
}

export interface AIComboTemplate {
  combo_template_key: string
  model_template_key: string
  provider_type?: string
  profile?: string
  provider_kind: string
  provider_category: string
...
export interface AIComboTemplatesResponse {
  items: AIComboTemplate[]
}
...
export interface AIModelImportProviderInput {
  provider_id?: string
  provider_kind?: string
  display_name: string
  base_url_prefix: string
...
export interface AIModelImportModelPlan {
  provider_model_id: string
  public_model_id: string
  display_name: string
  capabilities: string[]
...
export interface AIModelImportSummary {
  total: number
  recommended: number
  created_catalog_entries: number
  reused_catalog_entries: number
  created_route_bindings: number
  skipped_route_bindings: number
}

export interface AIModelImportPreviewResult {
  provider_kind: string
  display_name: string
  base_url: string
  route_group: string
  models: AIModelImportModelPlan[]
  summary: AIModelImportSummary
}

export interface AIModelImportApplyItem extends AIModelImportModelPlan {
  route_binding_id?: number
  created_catalog_entry: boolean
  created_route_binding: boolean
  reused_catalog_entry: boolean
  skipped_route_binding: boolean
}

export interface AIModelImportApplyResult {
  provider: AIProvider
  route_group: string
  items: AIModelImportApplyItem[]
  summary: AIModelImportSummary
}
