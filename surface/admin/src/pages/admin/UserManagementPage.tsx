...
import { createAuthUser, listAuthUsers, updateAuthUser } from '@admin/lib/authManagementApi'
...
import { orgListHref } from '@admin/lib/adminOrgQueryParams'
...
} from '@admin/lib/adminUserQueryParams'
import { cn } from '@admin/lib/utils'
import { useUserStore } from '@admin/store/userStore'
import type { PaginatedResponse, User } from '@admin/types'
...
export function UserManagementPage() {
  ...
  const createUser = useMutation({
    mutationFn: (form: CreateUserForm) => createAuthUser({
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          ...
          <div className="mt-3 flex justify-end gap-2">
            ...
            <Button
              ...
              disabled={createUser.isPending || !createForm.username.trim()}
            >
