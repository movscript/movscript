...
const SOURCE_FILES = {
  ...
  assetTool: 'apps/agent/catalog/tools/candidate/asset-slot-attach.tool.json',
  frontendAssetTool: 'apps/frontend/movscript-agent/catalog/tools/candidate/asset-slot-attach.tool.json',
  keyframeTool: 'apps/agent/catalog/tools/candidate/keyframe-attach.tool.json',
  frontendKeyframeTool: 'apps/frontend/movscript-agent/catalog/tools/candidate/keyframe-attach.tool.json',
  createJobTool: 'apps/agent/catalog/tools/generation/job-create.tool.json',
  frontendCreateJobTool: 'apps/frontend/movscript-agent/catalog/tools/generation/job-create.tool.json',
  contextTool: 'apps/agent/catalog/tools/movscript/workspace/production-context-query.tool.json',
  movscriptPack: 'apps/agent/catalog/packs/movscript.pack.json',
  movscriptPolicy: 'apps/agent/catalog/skills/movscript/policy/workspace/instruction.md',
  frontendMovscriptPolicy: 'apps/frontend/movscript-agent/catalog/skills/movscript/policy/workspace/instruction.md',
  assetProposalInstruction: 'apps/agent/catalog/skills/movscript/workflow/proposal/asset/asset_proposal/instruction.md',
  frontendAssetProposalInstruction: 'apps/frontend/movscript-agent/catalog/skills/movscript/workflow/proposal/asset/asset_proposal/instruction.md',
  assetCandidateInstruction: 'apps/agent/catalog/skills/candidate/workflow/asset_planning/instruction.md',
  frontendAssetCandidateInstruction: 'apps/frontend/movscript-agent/catalog/skills/candidate/workflow/asset_planning/instruction.md',
  visualGenerationWorkflow: 'apps/agent/catalog/skills/generation/workflow/visual_execution/skill.workflow.json',
  frontendVisualGenerationWorkflow: 'apps/frontend/movscript-agent/catalog/skills/generation/workflow/visual_execution/skill.workflow.json',
  visualGenerationInstruction: 'apps/agent/catalog/skills/generation/workflow/visual_execution/instruction.md',
  frontendVisualGenerationInstruction: 'apps/frontend/movscript-agent/catalog/skills/generation/workflow/visual_execution/instruction.md',
...
const REQUIRED_SOURCE_MARKERS = {
  ...
  mcpServer: [
    ["name: 'candidate_asset_slot_attach'", 'MCP server must expose asset candidate attach tool'],
    ["name: 'candidate_keyframe_attach'", 'MCP server must expose keyframe candidate attach tool'],
  ...
  mcpServerTest: [
    ['candidate_keyframe_attach', 'MCP tests must cover keyframe candidate attach'],
  ...
  assetTool: [
    ['"name": "candidate_asset_slot_attach"', 'asset candidate tool catalog must keep the attach tool name'],
  ...
  keyframeTool: [
    ['"name": "candidate_keyframe_attach"', 'keyframe candidate tool catalog must keep the attach tool name'],
  ...
  movscriptPack: [
    ['"candidate_keyframe_attach"', 'agent pack must include keyframe candidate attach tool'],
  ],
  movscriptPolicy: [
  ...
  visualGenerationWorkflow: [
    ['"tool://candidate_keyframe_attach"', 'visual generation workflow must include keyframe candidate attach tool'],
  ],
  visualGenerationInstruction: [
    ...
    ['candidate_keyframe_attach', 'visual generation instruction must attach successful keyframe outputs as candidates'],
  ...
  catalogLayeringTest: [
    ['candidate_keyframe_attach', 'catalog layering tests must cover keyframe candidate attach tool visibility'],
