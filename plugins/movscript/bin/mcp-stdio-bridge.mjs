...
const domainTools = [
  ...
  },
  {
    ...
    description: 'Convert a production preview timeline plus selected scene_moment video candidates into an OpenCut-compatible production timeline document.',
  ...
  },
  {
    ...
    description: 'Convert a scene_moment edit plan into an OpenCut-compatible timeline document for MVP timeline UI or agent editing.',
    inputSchema: projectSchema({
      ...workspaceLocatorProperties(),
  ...
  },
  {
    ...
    description: 'Apply OpenCut-style split, trim, move, delete, or insert commands to a scene_moment timeline document and return updated compose inputs.',
    inputSchema: projectSchema({
      ...workspaceLocatorProperties(),
      sceneMomentId: { type: ['string', 'number'] },
      scene_moment_id: { type: ['string', 'number'] },
  ...
  },
  {
    ...
    description: 'Apply OpenCut-style split, trim, move, delete, or insert commands to a production timeline document and return updated compose inputs.',
    inputSchema: projectSchema({
      ...workspaceLocatorProperties(),
      productionId: { type: ['string', 'number'] },
      production_id: { type: ['string', 'number'] },
  ...
  },
  {
    ...
    description: 'Compose the final production video candidate from an OpenCut-compatible production timeline document or the current production timeline.',
    inputSchema: projectSchema({
      ...workspaceLocatorProperties(),
      productionId: { type: ['string', 'number'] },
      production_id: { type: ['string', 'number'] },
      ...
      maxVideoBytes: { type: 'number' },
      max_upload_bytes: { type: 'number' },
  ...
  },
  {
    ...
    description: 'Compose a scene_moment final video candidate from its edit plan or an edited OpenCut-compatible timeline document.',
    inputSchema: projectSchema({
      ...workspaceLocatorProperties(),
      sceneMomentId: { type: ['string', 'number'] },
      scene_moment_id: { type: ['string', 'number'] },
