---
name: project
description: Resolve MovScript project focus, create projects only on explicit request, and orient agents to source, backend decisions, and debug artifacts.
toolGrants:
