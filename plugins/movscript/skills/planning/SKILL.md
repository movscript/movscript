...
9. Plan in dependency order only for the layers the chosen path needs: project standards, settings, assets, production, segments, scene moments, expression units, optional visual/audio anchors, and content units.
