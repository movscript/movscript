...
type UpdateSpec struct {
	...
	ProviderAssetCertifications map[string]any
...
type RawResource struct {
	...
	ProviderAssetCertifications map[string]any `json:"provider_asset_certifications,omitempty"`
...
func (spec UpdateSpec) Empty() bool {
	return spec.Name == nil &&
		...
		spec.ProviderAssetCertifications == nil &&
		spec.ProviderGeneratedArtifact == nil
}
...
func (resource *RawResource) ApplyUpdate(spec UpdateSpec) {
	...
	if spec.ProviderAssetCertifications != nil {
		resource.ProviderAssetCertifications = spec.ProviderAssetCertifications
	}
	if spec.ProviderGeneratedArtifact != nil {
		resource.ProviderGeneratedArtifact = spec.ProviderGeneratedArtifact
	}
}
