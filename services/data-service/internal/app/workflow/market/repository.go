...
type repository interface {
	...
	CreateCanvasFromTemplate(ctx context.Context, ownerID uint, tpl domainmarket.TemplateDef, name string, stage string) (canvasdomain.Canvas, error)
}
...
func (r *gormRepository) CreateCanvasFromTemplate(ctx context.Context, ownerID uint, tpl domainmarket.TemplateDef, name string, stage string) (canvasdomain.Canvas, error) {
	cv := domainmarket.TemplateCanvas(ownerID, tpl, name, stage).ToModel()
