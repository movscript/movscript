...
func newRepository(db *gorm.DB) repository {
	return newRepositoryWithIdentity(db, nil)
}

func newRepositoryWithIdentity(db *gorm.DB, identity orgReader) repository {
	return &gormRepository{db: db, identity: identity}
}
