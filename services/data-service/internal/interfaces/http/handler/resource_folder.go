...
func NewResourceFolderHandler(db *gorm.DB, cacheStore ...cache.Cache) *ResourceFolderHandler {
	return NewResourceFolderHandlerWithIdentity(db, nil, cacheStore...)
}

func NewResourceFolderHandlerWithIdentity(db *gorm.DB, identity authidentity.OrgDirectory, cacheStore ...cache.Cache) *ResourceFolderHandler {
	return &ResourceFolderHandler{service: appresourcefolder.NewServiceWithIdentity(db, identity, cacheStore...)}
}
