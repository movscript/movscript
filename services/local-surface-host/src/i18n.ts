  ...
  'zh-CN': {
    translation: {
      ...
      localSurfaceHost: {
        ...
        home: {
          title: 'App Home',
          description: '继续本地项目，或进入工具、画布、剪辑和资源工作区。',
          primaryAction: '打开 Tool Home',
          secondaryAction: '查看项目',
          workspaceTitle: '继续创作',
          workspaceDescription: '从最近项目开始，或者进入工具入口准备素材、画布和剪辑。',
          mcpReady: 'MCP 代理已就绪',
          localDirect: '本地直连',
          resources: '资源库',
        ...
        homes: {
          ...
          toolTitle: 'Tool Home',
          toolDescription: '集中打开资源、剪辑、画布和 agent 相关工具。',
          toolAction: '进入工具',
          ...
          jobs: {
            title: '生成记录',
            description: '查看本地图片、视频、音频和画布生成任务的状态与输出。',
          },
          system: {
        ...
        toolHome: {
          title: 'Tool Home',
          description: '一个本地创作工具入口：准备素材、进入剪辑、打开画布，或查看 agent 资源。',
        ...
        jobs: {
          ...
          categoryFilter: '类型筛选',
          empty: '还没有生成记录',
          emptyHint: '从生成工具、画布或 agent 提交任务后会出现在这里。',
          noPrompt: '（无提示词）',
          retry: '重试',
          cancel: '取消',
          previous: '上一页',
    ...
    translation: {
      ...
      localSurfaceHost: {
        ...
        home: {
          ...
          workspaceDescription: 'Start from a recent project, or enter the tool launcher to prepare assets, canvases, and edits.',
        ...
        homes: {
          ...
          toolTitle: 'Tool Home',
          toolDescription: 'Open resources, editing, canvases, and agent-facing tools from one place.',
          ...
          canvas: {
            title: 'Canvas Home',
            description: 'Manage canvases for boards, visual planning, and project inspiration.',
          },
          external: {
            title: 'External Resources',
        ...
        toolHome: {
          title: 'Tool Home',
          description: 'A local creative tool launcher for preparing assets, entering edits, opening canvases, and reviewing agent resources.',
