...
export function createSdkRuntimeAPI(ipcRenderer: IpcRenderer): Pick<ElectronAPI, 'sdkRuntimeRequest' | 'sdkRuntimePackageStatus' | 'sdkRuntimeCancelPackageInstall' | 'sdkRuntimeInstallAppServerPackage' | 'sdkRuntimeNotify' | 'sdkRuntimeRespondToServerRequest' | 'onSdkRuntimeNotification' | 'onSdkRuntimeServerRequest'> {
  ...
  return {
    ...
    sdkRuntimeInstallAppServerPackage: () => ipcRenderer.invoke('sdk-runtime:app-server-package-install'),
