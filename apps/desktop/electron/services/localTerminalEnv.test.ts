...
test('localTerminalEnv injects data service auth and base URL for movcli', () => {
  ...
  assert.equal(env.MOVCLI_TOKEN, undefined)
  assert.equal(env.MOVCLI_USER_ID, undefined)
