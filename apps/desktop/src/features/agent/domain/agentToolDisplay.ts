...
const TOOL_NAME_LABELS_ZH: Record<string, string> = {
  ...
  generation_voiceover_generate: '提交配音生成',
  generation_music_generate: '提交音乐生成',
  generation_sfx_generate: '提交音效生成',
  generation_subtitle_generate: '提交字幕生成',
  generation_subtitle_align: '提交字幕对齐',
  generation_subtitle_translate: '提交字幕翻译',
  ...
  system_generate_voiceover: '提交配音生成',
  system_generate_music: '提交音乐生成',
  system_generate_sfx: '提交音效生成',
  system_generate_subtitle: '提交字幕生成',
  system_align_subtitle: '提交字幕对齐',
  system_translate_subtitle: '提交字幕翻译',
  ...
  core_work_cancel: '取消旧异步任务',
  core_work_get: '查看旧异步任务',
  core_work_list: '查看旧异步任务列表',
  core_work_start: '旧异步任务交接',
  core_work_wait: '观察旧异步任务',
}
...
const PERMISSION_LABELS_ZH: Record<string, string> = {
  ...
  'agent.work.read': '读取旧异步任务',
  'agent.work.write': '管理旧异步任务',
