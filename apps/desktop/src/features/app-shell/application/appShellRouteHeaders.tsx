...
import { AudioLines, BriefcaseBusiness, CircleUserRound, Clapperboard, FileText, GitBranch, HardDrive, Image as ImageIcon, KeyRound, LayoutDashboard, Plug, Scissors, Settings, Video, Wand2, type LucideIcon } from 'lucide-react'
...
export function projectRouteHeaderTitle(pathname: string): ReactNode | undefined {
  const routeTitles: Array<{
    ...
    { match: (value) => value === ROUTES.project.scripts, icon: Clapperboard, title: '创作编排' },
    { match: (value) => value === ROUTES.project.standards, icon: LayoutDashboard, title: '项目规范' },
