...
export function createAppShellLayoutHeaders({
  ...
  const useProjectHomeHeaderControl = !!currentProject && (projectChrome || agentChrome)
  ...
  const agentNavigationControls = navigationHomeControl
  ...
  const toolLeftHeader = toolChrome && !toolSidebarHidden ? (
    <Header
      ...
      navigationControls={navigationHomeControl}
      layoutControls={accountSettingsActiveTab ? settingsSidebarLayoutControls : toolSidebarLayoutControls}
      leftControlsLayout="fill"
    />
  ) : undefined
  const toolCenterNavigationControls = toolChrome && toolSidebarHidden ? navigationHomeControl : undefined
