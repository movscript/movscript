...
export const ContentCanvasPage = lazyWithRetry(() => import('@movscript/project-surface/pages').then((module) => ({ default: module.ContentCanvasPage })))
export const ContentCanvasPreviewPage = lazyWithRetry(() => import('@movscript/project-surface/pages').then((module) => ({ default: module.ContentCanvasPreviewPage })))
...
export const ImageToolPage = lazyWithRetry(() => import('@/pages/tools/ImageToolPage'))
export const VideoToolPage = lazyWithRetry(() => import('@/pages/tools/VideoToolPage'))
export const AudioToolPage = lazyWithRetry(() => import('@/pages/tools/AudioToolPage'))
export const TextToolPage = lazyWithRetry(() => import('@/pages/tools/TextToolPage'))
...
export const AudioChatPage = lazyWithRetry(() => import('@/pages/tools/AudioChatPage'))
export const AudioTranscribePage = lazyWithRetry(() => import('@/pages/tools/AudioTranscribePage'))
export const AudioTranslatePage = lazyWithRetry(() => import('@/pages/tools/AudioTranslatePage'))
export const MusicGenPage = lazyWithRetry(() => import('@/pages/tools/MusicGenPage'))
export const AudioSfxPage = lazyWithRetry(() => import('@/pages/tools/AudioSfxPage'))
export const VoiceClonePage = lazyWithRetry(() => import('@/pages/tools/VoiceClonePage'))
export const VoiceDesignPage = lazyWithRetry(() => import('@/pages/tools/VoiceDesignPage'))
...
export const ProviderAssetLibraryPage = lazyWithRetry(() => import('@movscript/resource-surface/pages').then((module) => ({ default: module.ProviderAssetLibraryPage })))
...
export const ProjectEditDeskPage = lazyWithRetry(() => import('./DesktopProjectSurfaceRoutes').then((module) => ({ default: module.ProjectEditDeskPage })))
