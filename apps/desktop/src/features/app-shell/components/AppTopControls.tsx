...
import { openSettingsWindow } from '@/shared/infrastructure/appWindowContext'
...
export function AppTopControls({
  ...
  function openSettings() {
    if (settingsAction === 'appSettingsRoute' || settingsAction === 'accountDialog') {
      const route = settingsRouteWithReturnPath(pathname, search)
      void openSettingsWindow({ route })
    }
    setGlobalMenuOpen(false)
  }
