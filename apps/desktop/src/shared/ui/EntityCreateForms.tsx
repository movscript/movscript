...
import { readScriptDocument, SCRIPT_DOCUMENT_ACCEPT, scriptDocumentTitleFromName } from '@movscript/resource-surface/data'
import { createWorkspaceScript, invalidateScriptMutationResult, scriptCreatedResult, type ScriptWorkspaceRepositoryContext } from '@movscript/project-surface/data'
