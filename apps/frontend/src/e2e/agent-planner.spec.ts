...
test('planner run exposes plan overview and run detail drilldown', async ({ page }, testInfo) => {
  ...
  await expect(page.getByTestId('agent-run-debug-bundle-contract')).toContainText('9 项能力')
  ...
  expect(debugReportText).toContain('创建: 2026/05/12 17:00:00 (2026-05-12T09:00:00.000Z)')
