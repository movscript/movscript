...
const TOOL_NAME_LABELS_ZH: Record<string, string> = {
  ...
  search_file: '搜索文件',
  edit_file: '编辑文件',
  draft_file_read: '读取草稿文件',
  draft_file_search: '搜索草稿文件',
  draft_file_edit: '编辑草稿文件',
  draft_file_validate: '校验草稿文件',
  draft_validate: '校验草稿',
  ...
  core_subagent_list: '列出子代理',
  movscript_asset_slot_query: '查询素材槽',
  movscript_creative_reference_query: '查询创意参考',
  movscript_production_context_query: '查询制作上下文',
  movscript_project_script_read: '读取项目剧本',
  core_user_input_request: '请求用户补充',
  knowledge_search: '搜索知识',
  core_memory_search: '搜索记忆',
  core_subagent_spawn: '启动子代理',
  core_skill_update: '更新启用技能',
  core_subagent_wait: '等待子代理',
  core_operation_cancel: '取消后台任务',
  core_operation_get: '查看后台任务',
  core_operation_list: '查看后台任务列表',
  core_operation_start: '提交后台任务',
  core_operation_wait: '等待后台任务',
}
