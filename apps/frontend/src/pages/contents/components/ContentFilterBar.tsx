        ...
        {filters.map((filter) => (
          <label key={filter.id} className="flex h-9 items-center gap-2 rounded-md border border-border bg-background px-2.5">
            ...
            <select
              ...
              className="h-7 min-w-28 bg-transparent text-xs text-foreground outline-none"
            >
        ...
        <div className="flex flex-wrap items-center gap-2 border-t border-border px-4 py-2">
          ...
          {chips.map((chip) => (
            <button
              ...
              className="inline-flex h-6 max-w-[240px] items-center gap-1 rounded-md bg-muted px-2 text-[11px] text-muted-foreground transition-colors hover:text-foreground"
            >
