...
import { AlertCircle, ArrowRight, Database, FileText, LayoutDashboard } from 'lucide-react'
        ...
        actions={(
          <>
            ...
            <Button asChild className="gap-2">
              <Link to={overviewModel.nextLane?.definition.route ?? ROUTES.project.scripts}>
