...
function buildAreas(input: {
  ...
  return [
    ...
    },
    {
      ...
      href: ROUTES.project.sceneMoments,
    },
    {
      key: 'references',
      title: '设定资料',
...
function productionNextActionHref(action: string, production: ProductionRecord) {
  ...
  return area ? productionAreaHref(area, production) : withRouteParams(ROUTES.project.contentUnits, { production_id: production.dbId })
}
...
function productionAreaHref(area: ProductionArea, production: ProductionRecord) {
  ...
  if (area.key === 'content') return withRouteParams(ROUTES.project.contentUnits, { production_id: production.dbId })
