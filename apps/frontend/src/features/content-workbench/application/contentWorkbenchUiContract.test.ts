...
test('source workspace experience is the canonical project content entry', () => {
  ...
  assert.match(workspaceData, /content_candidate\.json/)
  assert.match(workspaceData, /selection\.json/)
  ...
  assert.match(workspaceTree, /export function buildChildNodePath/)
  assert.match(workspaceTree, /export function buildChildNodeId/)
  assert.match(workspaceTree, /scene_moments/)
