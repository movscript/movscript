...
import { shouldUseCanvasMediaLightweightMode } from '@/features/canvas/domain/layout'
import { canvasViewportSizeFromElement } from '@/features/canvas/presentation/canvasViewportGeometry'
