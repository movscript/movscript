...
test('content canvas workspace page delegates pane layout to route layout controllers', () => {
  const pageSource = readFileSync(resolve('src/features/content-canvas/components/ContentCanvasWorkspacePage.tsx'), 'utf8')
  const cssSource = readFileSync(resolve('src/features/content-canvas/components/ContentCanvasWorkspacePage.css'), 'utf8')
