...
type ProductionRecord = ProductionAnalysisEntityRecordLike & { script_version_id?: number; name?: string }
type SegmentRecord = ProductionAnalysisEntityRecordLike & { title?: string; summary?: string; content?: string; production_id?: number }
type SceneMomentRecord = ProductionAnalysisEntityRecordLike & {
  segment_id?: number
  title?: string
  time_text?: string
...
type AssetSlotRecord = ProductionAnalysisEntityRecordLike & {
  name?: string
  kind?: string
  priority?: string
  description?: string
...
function titleOfRecord(record: ProductionAnalysisEntityRecordLike | null | undefined) {
