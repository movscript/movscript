...
import { AgentConversationItem, AgentMain } from '@movscript/ui/business/agent'
...
import { AgentConversationHistoryPanel } from '@/features/agent/components/AgentConversationHistoryUi'
