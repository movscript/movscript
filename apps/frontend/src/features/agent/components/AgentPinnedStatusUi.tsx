...
import { AgentInlineEmpty, AgentPlanOverviewTaskStatusIcon } from '@movscript/ui/business/agent'
import { AppControlGroup, AppProgressBar } from '@movscript/ui/business/app'
import { Badge, Button } from '@movscript/ui/primitives'

import { cn } from '@/shared/ui/cn'

export { AgentPlanOverviewTaskStatusIcon }
...
export function AgentPinnedStatusStatusLine({
  title,
  detail,
  badge,
  tone = 'neutral',
  ...
  return (
    <div className="agent-pinned-status-status-line" data-tone={tone}>
      <div className="agent-pinned-status-status-line__copy">
        <div className="agent-pinned-status-status-line__title">{title}</div>
        {detail ? <div className="agent-pinned-status-status-line__detail">{detail}</div> : null}
      </div>
      {badge ? <AgentPinnedStatusBadge>{badge}</AgentPinnedStatusBadge> : null}
    </div>
  )
}
