import { assistantResultPayloadForRun, fetchResourceById, type AgentMessageViewModelDeps } from '@/features/agent/domain/agentMessageViewModel'
import { localAgentClient, type AgentRun, type AgentThread, type LocalAgentClient } from '@/shared/infrastructure/localAgentClient'
import { runtimeStatusLightFromThreadRuntimeSnapshot, type AgentRuntimeStatusLight } from '@/features/agent/domain/agentRuntimeStatusLight'
import { buildAgentSessionRuntimeView } from '@/features/agent/domain/agentSessionRuntimeProjection'
