...
test('instrumented agent state storage records low-cardinality storage metrics', () => {
  ...
  assert.equal(isAgentTelemetryReportableMetricName('frontend_agent_message_history_page_duration_ms'), true)
  assert.equal(isAgentTelemetryReportableMetricName('frontend_agent_message_history_page_messages'), true)
  assert.equal(isAgentTelemetryReportableMetricName('frontend_agent_message_history_page_payload_bytes'), true)
