...
export const AGENT_MODE_SIDEBAR_STATE_STORAGE_KEY = 'movscript-ai-ui-sidebar-collapsed'
...
export const AGENT_MODE_SIDEBAR_COLLAPSED_WIDTH = 0

export const AGENT_MODE_CONTENT_PANEL_STATE_STORAGE_KEY = 'movscript-ai-ui-content-panel-collapsed'
