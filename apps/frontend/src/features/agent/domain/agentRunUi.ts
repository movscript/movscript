import type { AgentApprovalRequest, AgentDraftStatus, AgentRun, AgentTraceEvent } from '@/shared/infrastructure/localAgentClient'
import { isRecord } from '@/shared/domain/jsonValue'
import { agentPermissionLabel, agentRiskLabel, agentToolNameLabel, agentToolNameWithId } from '@/features/agent/domain/agentToolDisplay'
...
function usageCachedInputTokens(usage: Record<string, unknown> | undefined): number | undefined {
...
function usageReasoningTokens(usage: Record<string, unknown> | undefined): number | undefined {
