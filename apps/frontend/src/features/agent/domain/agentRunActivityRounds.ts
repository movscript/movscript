import type { AgentTimelineActivity, AgentTimelineActivityApproval, AgentTimelineActivityEvent, AgentTimelineActivityInputRequest, AgentTimelineActivityStep } from '@movscript/core/agent/protocol'
