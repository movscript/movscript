import type { AgentAttachment, AgentChatMessage, AgentConversation, AgentConversationWorkspace, AgentConversationWorkspaceContext } from '@movscript/core/agent/protocol'
import type {
