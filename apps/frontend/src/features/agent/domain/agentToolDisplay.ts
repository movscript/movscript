...
const TOOL_NAME_LABELS_ZH: Record<string, string> = {
  ...
  system_generate_content_unit_image: '生成制作项图像',
  system_generate_content_unit_image_job_get: '写入图像候选',
  system_generate_content_unit_video: '生成制作项视频',
