...
test('resource page context menu positioning is owned by the resource interaction helper', () => {
  ...
  assert.match(externalResourceSearchSource, /subscribeExternalResourceSearchSnapshot/)
  assert.match(externalResourceSearchSource, /externalSearchUserEditedRef/)
