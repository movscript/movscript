...
test('macOS dock shortcuts mirror desktop root and recent jump entries', () => {
  ...
  assert.match(dockServiceSource, /App Home/)
  assert.match(dockServiceSource, /Tool Home/)
  assert.match(dockServiceSource, /openToolWindow\(\)/)
  assert.match(dockServiceSource, /Edit Home/)
  assert.match(dockServiceSource, /Canvas Home/)
