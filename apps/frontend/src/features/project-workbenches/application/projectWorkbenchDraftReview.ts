import { selectLatestDraftArtifact, type AgentTaskArtifactRef } from '@/features/agent/domain/agentArtifacts'
import type { AgentDraftKind } from '@/shared/infrastructure/localAgentClient'
import {
