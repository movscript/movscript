...
} from '@/features/content/domain/contentWorkbenchCanvas'
import { contentUnitGenerationCanvasDescription, type ContentUnitPlanningRecord } from '@/features/content/domain/contentUnitPlanningMetadata'
import { titleOfRecord, type OrderedWorkbenchRecord } from '@/features/content/domain/contentWorkbenchRecordUtils'
...
export function contentWorkbenchCanvasRoute(canvas: Pick<Canvas, 'ID'>) {
  return canvasEditorPath(canvas.ID, { source: 'detail' })
}
