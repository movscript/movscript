export function createProviderSessionRequestSignal(externalSignal: AbortSignal | undefined, timeoutMs: number): { signal: AbortSignal; cleanup: () => void } {
...
function createProviderSessionTimeoutError(timeoutMs: number): Error {
  try {
