...
export function buildAgentChatViewLayoutProps({
  ...
  return {
    ...
    thread: {
      ...
      onAnswerLocalRunInput: interaction.answerActiveLocalRunInput,
      onApproveLocalRun: interaction.approveActiveLocalRun,
      ...
      onRejectLocalRun: interaction.rejectActiveLocalRun,
