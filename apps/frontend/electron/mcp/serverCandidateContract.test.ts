...
test('MCP server exposes candidate tools and multi-output generation contracts', () => {
  ...
  assert.match(serverSource, /name:\s*'candidate_asset_slot_attach'/)
  assert.match(serverSource, /name:\s*'candidate_keyframe_attach'/)
  assert.match(serverSource, /case 'candidate_asset_slot_attach':/)
  assert.match(serverSource, /case 'candidate_keyframe_attach':/)
  ...
  assert.match(serverSource, /import \{ getRequiredPositiveIntegerAliasParam, getRequiredPositiveIntegerAliasParams \} from '\.\/candidateParams'/)
  ...
  assert.match(serverSource, /getRequiredPositiveIntegerAliasParams\(args, resourceIdAliases, 'resource_id'\)/)
})
