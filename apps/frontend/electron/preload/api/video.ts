...
export function createVideoAPI(ipcRenderer: IpcRenderer): Pick<ElectronAPI, 'clipVideo' | 'exportTimelineVideo' | 'getVideoClipStatus' | 'analyzeShotCuts'> {
  return {
    ...
    analyzeShotCuts: (input) => ipcRenderer.invoke('video:shot-cuts', input),
  }
}
