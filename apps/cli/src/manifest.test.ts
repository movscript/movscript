...
test('loads Codex plugin manifest before legacy mov.json', () => {
...
test('falls back to legacy mov.json when Codex plugin manifest is absent', () => {
