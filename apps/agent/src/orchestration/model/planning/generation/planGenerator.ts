import { resolveRuntimePlannerModelConfig, type RuntimeModelAuthContext } from '../../../../model/config/modelConfig.js'
...
import { cloneJSONValue, isJSONRecord, isRecord } from '../../../../shared/json/jsonValue.js'
import type { CreateTaskGraphTaskInput, JSONValue } from '../../../../state/shared/types.js'
  ...
  return [
    {
      ...
      content: runtimeModelTextContent([
        ...
        'The plan is the primary structure; worker/subagent execution is orthogonal and optional.',
        'If the user explicitly asks for worker/subagent/parallel execution, follow that intent unless the task boundary is impossible or unsafe.',
        'If the user explicitly asks not to use workers/subagents, keep executionMode="planner".',
        'When the user does not specify worker/subagent use, choose planner_only for simple, single-context, immediately blocking work; do not manufacture worker tasks for it.',
