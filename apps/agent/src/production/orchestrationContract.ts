import type { AgentRuntimeContract } from '../runtime/contracts/runtimeContract.js'
...
export const PRODUCTION_ORCHESTRATION_OUTPUT_SCHEMA = {
  ...
  $defs: {
    ...
    segment_proposal: {
      ...
      required: ['client_id', 'action', 'id', 'title', 'kind', 'summary', 'scene_moments'],
    },
    scene_moment_proposal: {
      ...
      properties: {
        ...
        asset_slots: { type: 'array', items: { $ref: '#/$defs/asset_slot_proposal' } },
      },
      required: ['client_id', 'source_temp_id', 'action', 'id', 'title', 'description', 'time_text', 'location_text', 'action_text', 'mood', 'creative_references', 'content_units', 'asset_slots'],
    },
    ...
    content_unit_proposal: {
      ...
      required: ['client_id', 'action', 'id', 'kind', 'title', 'description', 'shot_size', 'camera_angle', 'prompt', 'duration_sec'],
    },
    asset_slot_proposal: {
      type: 'object',
      additionalProperties: false,
      ...
      required: ['client_id', 'action', 'id', 'kind', 'name', 'description', 'priority'],
    },
  },
  ...
  properties: {
    ...
    candidates: {
      ...
      properties: {
        ...
        creative_references: { type: 'array', items: { type: 'object', additionalProperties: true } },
        asset_slots: { type: 'array', items: { type: 'object', additionalProperties: true } },
