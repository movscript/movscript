import type { AgentMessage, AgentRunInput, AgentRunRole, AgentTask, JSONValue, ToolCall } from '../../../shared/types.js'
import { cloneJSONValue, isRecord } from '../../../../shared/json/jsonValue.js'
import { WORKER_TASK_INSTRUCTIONS } from '../../../taskgraph/projection/prompt/workerTaskPrompt.js'
