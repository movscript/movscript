...
import type { AgentInputRequest, AgentRun } from '../../shared/types.js'
import {
...
test('mergePendingApprovals preserves same-tool approvals with different args', () => {
  const first = { ...approval('approval_1', 'core_work_start'), args: { prompt: 'A' } }
  const second = { ...approval('approval_2', 'core_work_start'), args: { prompt: 'B' } }
