...
import { buildRuntimeContractMetadata } from '../../../../contracts/runtime/runtimeContract.js'
...
import type { AgentRun, AgentRunInput, AgentRuntimeLimits, AgentRunRole, JSONValue, ToolCall } from '../../../shared/types.js'
...
export function buildRunCreationMetadata(input: {
  ...
  return {
    ...
    ...(input.configurationSnapshot ? { configurationSnapshot: cloneJSONValue(input.configurationSnapshot) } : {}),
  }
}
