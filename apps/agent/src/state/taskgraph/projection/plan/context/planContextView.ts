import type { AgentDebugContextPanel, AgentTaskGraph, AgentTaskGraphSnapshot, AgentRun, AgentTask, JSONValue } from '../../../../shared/types.js'
import { agentPlanSummary, taskArtifactReferences } from '../snapshot/planSnapshot.js'
import { subagentNameConflicts, subagentNameFromRun, subagentNameFromTask } from '../../../../subagent/identity/subagentIdentity.js'
import { toSubagentRunSummary } from '../../../../subagent/view/subagentRunView.js'
