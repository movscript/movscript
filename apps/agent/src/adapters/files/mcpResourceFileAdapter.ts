import { contentRevision } from '../../files/core/edit/agentFileEdit.js'
import { isJSONRecord, isJSONValue } from '../../shared/json/jsonValue.js'
import type { MCPClient } from '../mcp/client/mcpClient.js'
import type { CoreResourceFilePort, CoreResourceFileReadOptions } from '../../ports/files/resourceFilePort.js'
