...
test('catalog startup report summarizes pack-enabled skills and tools', () => {
  ...
  assert.ok(report.enabledPacks.includes('core.pack.agent'))
  assert.ok(report.enabledPacks.includes('draft.pack.lifecycle'))
  assert.ok(report.enabledPacks.includes('movscript.pack.workspace'))
