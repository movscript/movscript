...
export const DEFAULT_AGENT_MANIFEST: AgentManifest = {
  ...
  version: '0.1.0',
  name: 'Local Agent',
  description: 'Default local agent with generic file, workspace, memory, catalog, and work orchestration permissions. Business tools are provided by MCP and installed skills.',
  tools: [
