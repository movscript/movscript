...
export const DEFAULT_AGENT_MANIFEST: AgentManifest = {
  ...
  tools: [
    ...
    { name: 'agent_io_get', mode: 'allow', approval: 'never' },
    { name: 'agent_io_list', mode: 'allow', approval: 'never' },
    { name: 'agent_io_wait', mode: 'allow', approval: 'never' },
    { name: 'agent_io_cancel', mode: 'allow', approval: 'never' },
