# content-unit-media-proposal / no-context

profile: movscript.profile.content-unit-media-proposal@1.0.0
parts: movscript.persona.visual-director, movscript.policy.approval-boundaries, movscript.policy.safe-drafts, movscript.policy.platform-concepts, movscript.workflow.content-unit-media-proposal, movscript.workflow.proposal-first, movscript.workflow.script-writing, movscript.workflow.project-progress, movscript.workflow.storyboard-gap-review
...
Goal: produce or edit a local content_unit_media_proposal draft for media, shots, or keyframes.

Draft schema: movscript.content_unit_media_proposal.v1
...
Output contract:
Return draftId, content unit targets, planned media/keyframe count, preview status, and open decisions.
