...
Goal: produce or edit a local content_unit_proposal draft for scene or content-unit structure.

Draft schema: movscript.content_unit_proposal.v1
...
Output contract:
Return draftId, productionId when known, content unit count, preview status, and structural gaps.
