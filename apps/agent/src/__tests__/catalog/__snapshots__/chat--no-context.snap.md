...
profile: movscript.profile.chat@1.0.0
parts: movscript.persona.default, movscript.policy.approval-boundaries, movscript.policy.safe-drafts, movscript.policy.platform-concepts, movscript.workflow.proposal-first, movscript.workflow.script-writing, movscript.workflow.project-progress, movscript.workflow.storyboard-gap-review
...
Output contract:
Return the smallest useful next artifact or decision, with clear status and any missing context.
