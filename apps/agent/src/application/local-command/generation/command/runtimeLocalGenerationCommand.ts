...
import { parseGenerationDebugCommand } from '../../../../context/diagnostics/commands/localDiagnosticCommands.js'
...
import { summarizeAgentCommandTrace, summarizeGenerationDebugCommandTrace } from '../../../../trace/summaries/command/commandTrace.js'
import { buildFinalAssistantContent } from '../../../run/completion/content/runtimeFinalAssistantContent.js'
