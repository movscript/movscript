import { formatInputAnswerMessage } from '../../../../context/input/run/normalizeRunInput.js'
import { buildRuntimeUserMessage, type NormalizedClientInput } from '../../../../context/input/client/normalizeClientInput.js'
import { resolveRunInputUserMessage } from '../../../../state/run/input/snapshot/runInput.js'
