...
const facadeDelegates = [
  ...
  ['listProfileCatalog', 'this.catalogOperations.listProfileCatalog()'],
  ['setDefaultAgentProfile', 'this.catalogSettings.setDefaultAgentProfile(input)'],
  ['setDefaultToolPolicy', 'this.catalogSettings.setDefaultToolPolicy(input)'],
  ['setDefaultSkillPolicy', 'this.catalogSettings.setDefaultSkillPolicy(input)'],
  ...
  ['updateProgressChecklist', 'updateRuntimeProgressChecklist({'],
  ...
  ['startOperation', 'this.runtimeOperations.startOperation(run, input, options)'],
  ['getOperation', 'this.runtimeOperations.getOperation(run, input)'],
  ['listOperation', 'this.runtimeOperations.listOperation(run, input)'],
  ['waitOperation', 'this.runtimeOperations.waitOperation(run, input, options)'],
  ['cancelOperation', 'this.runtimeOperations.cancelOperation(run, input, options)'],
