import type { RuntimeWorkManager } from '../../../runtime-work/manager/runtimeWorkManager.js'
import type { RuntimeWork, RuntimeWorkKind } from '../../../runtime-work/core/runtimeWork.js'
import type { AgentRun, AgentTraceEvent, JSONValue } from '../../../state/shared/types.js'
import type { RuntimeWakeCoordinator } from '../wake/runtimeWakeCoordinator.js'
import { summarizeRuntimeWorkTrace, summarizeRuntimeWorkWaitTrace } from '../../../trace/summaries/tool/call/toolTrace.js'
