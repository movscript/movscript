...
import type { AgentDraft, AgentDraftStore } from '../../../drafts/store/draftStore.js'
import { validateDraft } from '../../../drafts/store/draftStore.js'
import { buildApplyDraftPreview, markDraftApplied, rejectDraft, type ApplyDraftInput, type ApplyDraftReview } from '../../../drafts/apply/draftApply.js'
import {
  assetProposalContainsAssetSlots,
  canonicalizeProjectStandardsProposalDraftContent,
} from '../../../drafts/runtime/content/draftRuntimeContent.js'
import {
...
} from '../../../drafts/runtime/input/draftRuntimeInput.js'
import { normalizeDraftQuery } from '../../../context/input/run/normalizeRunInput.js'
import type { RuntimeDraftBackendApplyPort, RuntimeDraftBackendApplyResult } from '../../../ports/draft/backend/runtimeDraftBackendApplyPort.js'
