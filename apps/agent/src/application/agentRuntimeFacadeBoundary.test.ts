...
const facadeDelegates = [
  ...
  ['startIO', 'this.ioOperations.startIO(run, input, options)'],
  ['getIO', 'this.ioOperations.getIO(run, input)'],
  ['listIO', 'this.ioOperations.listIO(run, input)'],
  ['waitIO', 'this.ioOperations.waitIO(run, input, options)'],
  ['cancelIO', 'this.ioOperations.cancelIO(run, input, options)'],
