...
5. 给出最少的下一步 task 建议，例如继续 project_standards_proposal（项目标准）、setting_proposal（设定资料）、asset_proposal（素材需求或素材候选）、production_proposal、content_unit_proposal、visual_generation 或 storyboard_gap_review。
...
输出合同：
返回已验证进度、未关闭 drafts、阻塞项、未知项和推荐下一步 task。
