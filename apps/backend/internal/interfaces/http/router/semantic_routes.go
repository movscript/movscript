...
func registerSemanticEntityRoutes(protected *gin.RouterGroup, h handlers) {
	...
	protected.POST("/projects/:id/entities/project-standards-workspaces/apply-preview", h.semanticEntities.PreviewProjectStandardsWorkspaceApply)
	protected.POST("/projects/:id/entities/project-standards-workspaces/apply", h.semanticEntities.ApplyProjectStandardsWorkspace)
	protected.POST("/projects/:id/entities/setting-workspaces/apply-preview", h.semanticEntities.PreviewSettingWorkspaceApply)
	protected.POST("/projects/:id/entities/setting-workspaces/apply", h.semanticEntities.ApplySettingWorkspace)
	protected.POST("/projects/:id/entities/asset-workspaces/apply-preview", h.semanticEntities.PreviewAssetWorkspaceApply)
	protected.POST("/projects/:id/entities/asset-workspaces/apply", h.semanticEntities.ApplyAssetWorkspace)
	protected.POST("/projects/:id/entities/production-workspaces/apply-preview", h.semanticEntities.PreviewProductionWorkspaceApply)
	protected.POST("/projects/:id/entities/production-workspaces/apply", h.semanticEntities.ApplyProductionWorkspace)
