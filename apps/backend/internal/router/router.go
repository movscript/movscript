...
func New(db *gorm.DB, cfg *config.Config, store storage.Storage) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		protected := v1.Group("", middleware.RequireAuth())
		{
			...
			protected.GET("/projects/:id/production-management/draft", scriptPreview.GetLatestDraft)
			protected.POST("/projects/:id/production-management/draft", scriptPreview.SaveDraft)
			protected.POST("/projects/:id/production-management/analyze", scriptPreview.AnalyzeScriptToSections)
			protected.POST("/projects/:id/production-management/generate-preview", scriptPreview.GenerateKeyframesForContentUnits)
			protected.POST("/projects/:id/production-management/confirm-preview", scriptPreview.ConfirmPreview)
			protected.POST("/projects/:id/production-management/storyboard-suggestions/accept", scriptPreview.AcceptStoryboardSuggestion)
			protected.POST("/projects/:id/production-management/storyboard-suggestions/reject", scriptPreview.RejectStoryboardSuggestion)
			protected.POST("/projects/:id/production-management/keyframe-candidates/accept", scriptPreview.AcceptKeyframeCandidate)
			protected.POST("/projects/:id/production-management/keyframe-candidates/reject", scriptPreview.RejectKeyframeCandidate)
			protected.POST("/projects/:id/production-management/asset-gaps/accept", scriptPreview.AcceptAssetGap)
			protected.POST("/projects/:id/production-management/asset-gaps/resolve", scriptPreview.ResolveAssetGap)
			protected.POST("/projects/:id/production-management/asset-gaps/reject", scriptPreview.RejectAssetGap)
			protected.GET("/projects/:id/production-preview/draft", scriptPreview.GetLatestDraft)
			protected.POST("/projects/:id/production-preview/draft", scriptPreview.SaveDraft)
			protected.POST("/projects/:id/production-preview/analyze", scriptPreview.AnalyzeScriptToSections)
			protected.POST("/projects/:id/production-preview/generate-preview", scriptPreview.GenerateKeyframesForContentUnits)
			protected.POST("/projects/:id/production-preview/confirm-preview", scriptPreview.ConfirmPreview)
			protected.POST("/projects/:id/production-preview/storyboard-suggestions/accept", scriptPreview.AcceptStoryboardSuggestion)
			protected.POST("/projects/:id/production-preview/storyboard-suggestions/reject", scriptPreview.RejectStoryboardSuggestion)
			protected.POST("/projects/:id/production-preview/keyframe-candidates/accept", scriptPreview.AcceptKeyframeCandidate)
			protected.POST("/projects/:id/production-preview/keyframe-candidates/reject", scriptPreview.RejectKeyframeCandidate)
			protected.POST("/projects/:id/production-preview/asset-gaps/accept", scriptPreview.AcceptAssetGap)
			protected.POST("/projects/:id/production-preview/asset-gaps/resolve", scriptPreview.ResolveAssetGap)
			protected.POST("/projects/:id/production-preview/asset-gaps/reject", scriptPreview.RejectAssetGap)
			...
			protected.POST("/projects/:id/script-preview/keyframe-candidates/reject", scriptPreview.RejectKeyframeCandidate)
			protected.POST("/projects/:id/script-preview/asset-gaps/accept", scriptPreview.AcceptAssetGap)
			protected.POST("/projects/:id/script-preview/asset-gaps/resolve", scriptPreview.ResolveAssetGap)
			protected.POST("/projects/:id/script-preview/asset-gaps/reject", scriptPreview.RejectAssetGap)
			...
			protected.DELETE("/projects/:id/v2/script-sections/:sectionId", func(c *gin.Context) { v2Semantics.DeleteV2Item(c, &model.ScriptSection{}, c.Param("sectionId")) })
			...
			protected.DELETE("/projects/:id/v2/situations/:situationId", func(c *gin.Context) { v2Semantics.DeleteV2Item(c, &model.Situation{}, c.Param("situationId")) })
