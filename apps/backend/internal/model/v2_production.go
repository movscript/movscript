...
type WorkItem struct {
	gorm.Model
	ProjectID      uint   `gorm:"not null;index" json:"project_id"`
	TargetType     string `gorm:"not null;index:idx_work_item_target" json:"target_type"` // segment|scene_moment|content_unit|creative_reference|creative_reference_state|asset_slot|asset|keyframe|delivery_version
