...
// section, situation, content unit, or time period.
type CreativeReferenceState struct {
	...
	ScopeType           string             `gorm:"not null;index" json:"scope_type"` // script|script_section|situation|content_unit|time_period
...
type CreativeReferenceUsage struct {
	gorm.Model
	ProjectID                uint                    `gorm:"not null;index" json:"project_id"`
	OwnerType                string                  `gorm:"not null;index:idx_creative_usage_owner" json:"owner_type"` // script_section|situation|content_unit|keyframe
...
type CreativeRelationship struct {
	...
	ScopeType                 string             `gorm:"index" json:"scope_type"` // project|script|script_section|situation|content_unit
	ScopeID                   *uint              `gorm:"index" json:"scope_id,omitempty"`
