...
type ResourceBinding struct {
	...
	OwnerType string `gorm:"not null;index:idx_resource_binding_project_owner" json:"owner_type"` // script|setting|episode|scene|storyboard|shot|final_video|asset|asset_view|canvas
