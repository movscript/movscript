...
func TestCreateCreatesTeamOrgWithOwnerAndRejectsDuplicateSlug(t *testing.T) {
	db := testutil.OpenSQLite(t, "adminorg-create.db", &persistencemodel.User{}, &persistencemodel.Organization{}, &persistencemodel.OrganizationMember{})
...
func TestRotateJoinCodeUpdatesTeamOrgAndRejectsPersonalOrg(t *testing.T) {
	db := testutil.OpenSQLite(t, "adminorg-rotate-join-code.db", &persistencemodel.Organization{}, &persistencemodel.OrganizationMember{})
