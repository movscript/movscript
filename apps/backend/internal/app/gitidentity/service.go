...
func (s *Service) EnsureForUser(ctx context.Context, user domainauth.UserProfile) (Credential, error) {
	if user.ID == 0 {
...
func (s *Service) giteaUsername(user domainauth.UserProfile) string {
